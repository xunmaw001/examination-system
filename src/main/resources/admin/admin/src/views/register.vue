    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">考试系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            ...
                            <el-form-item label="头像" class="input" v-if="tableName=='laoshi'">
                                    <file-upload
                                        tip="点击上传头像"
                                        action="file/upload"
                                        :limit="1"
...
.container {
    ...
    background-repeat: no-repeat;
        background-image: url(/kaoshixitong/img/back-img-bg.jpg);
